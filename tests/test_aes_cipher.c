...
void test_aes_2_way_128(void) {
  ...
  input = str_to_arr("69c4e0d86a7b0430d8cdb78070b4c55a");
  output_target = str_to_arr("00112233445566778899aabbccddeeff");
  aes_decrypt_block(input, key_p, output);
  for(size_t idx =0; idx < sizeof(output); idx++){
    printf("%02x", output[idx]);
  }
...
void test_aes_2_way_192(void) {
  ...
  input = str_to_arr("dda97ca4864cdfe06eaf70a0ec0d7191");
  output_target = str_to_arr("00112233445566778899aabbccddeeff");
  aes_decrypt_block(input, key_p, output);
  for(size_t idx =0; idx < sizeof(output); idx++){
    printf("%02x", output[idx]);
...
void test_aes_2_way_256(void) {
  ...
  input = str_to_arr("8ea2b7ca516745bfeafc49904b496089");
  output_target = str_to_arr("00112233445566778899aabbccddeeff");
  aes_decrypt_block(input, key_p, output);
  for(size_t idx =0; idx < sizeof(output); idx++){
    printf("%02x", output[idx]);
